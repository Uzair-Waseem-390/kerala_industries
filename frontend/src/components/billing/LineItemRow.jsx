...
const LineItemRow = ({
    ...
    // selection, same one-shot/no-spinner/swallow-errors shape as Credit
    // Score on the Customer picker (CreateInvoicePage.jsx's
    // handleCustomerSelect). Purely informational display; the real
    ...
    const handleProductSelect = (value, option) => {
        ...
        if (!value) return;
        billingApi.getAvailableQuantity(option?.productType ?? 'fg', value, excludeInvoiceId)
