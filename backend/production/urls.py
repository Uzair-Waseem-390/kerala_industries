...
from .views import (
    ...
    CuttingBreakdownItemDetailView,
...
urlpatterns = [
    ...
    path("recipes/<int:pk>/name/",             UpdateRecipeNameView.as_view(),   name="recipe-update-name"),
    ...
    path("recipes/<int:pk>/breakdown-items/<int:item_id>/", BreakdownItemDetailView.as_view(), name="recipe-breakdown-item-detail"),
    ...
    path("cutting-recipes/<int:pk>/name/",             UpdateCuttingRecipeNameView.as_view(),       name="cutting-recipe-update-name"),
    ...
    path("cutting-recipes/<int:pk>/breakdown-items/<int:item_id>/", CuttingBreakdownItemDetailView.as_view(), name="cutting-recipe-breakdown-item-detail"),
    ...
    path("packing-recipes/<int:pk>/name/",             UpdatePackingRecipeNameView.as_view(),        name="packing-recipe-update-name"),
